...
public class MQClientInstance {
        ...
        synchronized (this) {
            switch (this.serviceState) {
                case CREATE_JUST:
                    ...
                    //如果客户端缓存的namesrvAddr为空的话，尝试从NameServer中获取
    ...
    private void startScheduledTask() {
        //如果客户端缓存的namesrvAddr为空的话，定时从NameServer中获取
        if (null == this.clientConfig.getNamesrvAddr()) {
                ...
                try {
                    ...
                    if (isDefault && defaultMQProducer != null) {
                        ...
                        if (topicRouteData != null) {
                            //如果查询到了，则替换路由信息中读写队列个数为消息生产者默认的队列个数
                    ...
                    if (topicRouteData != null) {
                        ...
                        if (!changed) {
                            //如果没有发生改变，则尝试遍历生产者和消费者，查看是否需要需要进行改变
